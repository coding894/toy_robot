...
class Commands
    ...
    def instructions
        ...
        puts ""
        puts "You can PLACE the robot in any location on the grid with x and y coordinates ranging from 0 to 4."
        ...
        puts ""
        puts "Once your robot is placed, you may move your robot around the grid with MOVE."      
        puts ""
        puts "Happy gaming!"
        puts ""
    end
